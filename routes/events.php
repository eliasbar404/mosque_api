...
Route::group([
    ...
    Route::post('/{id}/update'   ,[EventController::class, 'update_event'])->middleware('auth:admin')->name('updateEvent');
    Route::delete('/{id}',[EventController::class, 'delete_event'])->middleware('auth:admin')->name('deleteEvent');

    Route::patch('/{id}/publish',[EventController::class, 'publish_event'])->middleware('auth:admin')->name('publishEvent');
